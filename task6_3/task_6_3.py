...
class Scrapper(object):
    """
    Class Scrapper to asynchronous get and parse data from
    http://forum.overclockers.ua
    
    Takes 1 params - pages_count to async parse.
    start() - main method to start parsing.
    
    return list of records, contains (author, title, link, post)
    ...
    def start(self):
        ...
        try:
            event_loop.run_until_complete(self.create_session())
            data = event_loop.run_until_complete(self.main())
        finally:
...
if __name__ == "__main__":
    ...
    # Scrapp 5 pages, ~200 posts but save 10... for testing !
